                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-8">
                      <Button href="/discover" size="lg" className="bg-gradient-to-r from-[#36F9F6] to-[#FF3BFF] text-text-primary border-none shadow-lg shadow-[#FF3BFF]/20 hover:shadow-[#FF3BFF]/30 hover:scale-105 transition-all duration-300">
                        <Rocket size={18} className="mr-2" />
                        Explore NFTs
                      </Button>
                      <Button href="#how-it-works" variant="secondary" size="lg" className="backdrop-blur-md bg-white/5 border-white/10 text-text-primary hover:bg-white/10 hover:scale-105 transition-all duration-300">
                        Create Account
                      </Button>
                    </div>
              ...
              <div className="container-custom">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <Button href="/discover" variant="secondary" className="backdrop-blur-md bg-white/5 border-white/10 text-text-primary hover:bg-white/10 transition-all duration-300">
                      View All
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center pt-2 border-t border-white/10">
                          ...
                          <Button href="/discover" variant="secondary" size="sm" className="text-xs px-3 py-1 bg-white/5 hover:bg-white/10 border-white/10">
                            View
                          </Button>
                        </div>
                      </div>
